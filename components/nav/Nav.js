            ...
            <div className="relative flex items-center justify-between h-16">
              <div className="flex items-center px-2 lg:px-0">
                <div className="flex-shrink-0">
                  <Link href="/">
                    <a className="flex flex-row items-center rounded hover:bg-indigo-700 hover:text-white p-2">
                ...
                <div className="hidden lg:block lg:ml-6">
                  <div className="flex space-x-4">
                    <ActiveLink href="/activity" active="bg-gray-900 text-white" inactive="hover:bg-gray-700 hover:text-white">
                      <a className="px-3 py-2 rounded-md text-sm font-medium">Activity</a>
                    </ActiveLink>
                    ...
                    <ActiveLink href="/lists" active="bg-gray-900 text-white" inactive="hover:bg-gray-700 hover:text-white">
                      <a className="px-3 py-2 rounded-md text-sm font-medium">Lists</a>
                    </ActiveLink>
                  </div>
                </div>
              </div>
